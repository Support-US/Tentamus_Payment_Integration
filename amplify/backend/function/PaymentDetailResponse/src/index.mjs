...
export const handler = async (event) => {
    ...
    async function CreateData(DynamoDBdata) {
        ...
        // Extract Amount
        let totalAmount = JsonDBData.Amount; // This is the user-entered value (includes fee)

        // Calculate original amount and processing fee
        let originalAmount = totalAmount / 1.03; // Reverse 3% fee to get original amount
        let cardProcessingFee = totalAmount - originalAmount; // Fee amount
        ...
        let postData = {
            ...
            Amount: originalAmount.toString(), // Set original amount
            Transaction_ID: JsonDBData.id,
            ...
            CardProcessingFee: cardProcessingFee.toString()// Set processing fee 
    ...
    async function UpdatePaymentDetailsID(SAPdata) {
        ...
        let tableId = SAPdata.Transaction_ID;
        try {
            const params = {
