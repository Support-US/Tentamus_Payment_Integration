...
export default function PaymentDetailsCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setSAPUpdateStatusMessage(initialValues.SAPUpdateStatusMessage);
    setErrors({});
  };
  const validations = {
    ...
    >
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (errors.HMacPassword?.hasError) {
            runValidationTasks("HMacPassword", value);
          }
          setHMacPassword(value);
        }}
        onBlur={() => runValidationTasks("HMacPassword", HMacPassword)}
        errorMessage={errors.HMacPassword?.errorMessage}
        hasError={errors.HMacPassword?.hasError}
        {...getOverrideProps(overrides, "HMacPassword")}
      ></TextField>
      <TextField
        ...
        onChange={(e) => {
          ...
          if (errors.EncryptionPassword?.hasError) {
            runValidationTasks("EncryptionPassword", value);
          }
          setEncryptionPassword(value);
        }}
        onBlur={() =>
          runValidationTasks("EncryptionPassword", EncryptionPassword)
        }
        errorMessage={errors.EncryptionPassword?.errorMessage}
